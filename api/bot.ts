...
import { BotContext } from './types/bot.type';
...
export class Bot {
  ...
  private setupCommands() {
    ...
    // Auth commands
    this.bot.command('otp', this.authCommands.verifyOtp.bind(this.authCommands));

    // Email management commands
    this.bot.command('login', this.emailCommands.loginWithEmail.bind(this.emailCommands));
    this.bot.command('emails', this.emailCommands.listEmails.bind(this.emailCommands));
    this.bot.command('setdefault', this.emailCommands.setDefaultEmail.bind(this.emailCommands));
    this.bot.command('logout', this.emailCommands.logoutEmail.bind(this.emailCommands));
    this.bot.command('logoutall', this.emailCommands.logoutAll.bind(this.emailCommands));

    // Wallet commands
    this.bot.command('wallet', this.walletCommands.getWalletInfo.bind(this.walletCommands));

    // KYC commands
    this.bot.command('kyc', this.kycCommands.getKYCStatus.bind(this.kycCommands));
  }
